/**
 * Work-in-progress to port interaction.Modify to typescript
 * and mark some verticies as non-selectable (the first one in a line segment)
 * current show-stopper is ol.structs.RBush not being part of the API
 */
import ol = require("openlayers");

type ModifyEventType = 'modifystart' | 'modifyend';

class ModifyEvent extends ol.events.Event {

    constructor(type: ModifyEventType, public features: ol.Collection<ol.Feature>, public mapBrowserEvent: ol.MapBrowserPointerEvent) {
        super(type);
    };
}
...
class Modify extends ol.interaction.Pointer {
    ...
    condition_: any;    
    defaultDeleteCondition_: Function;
    deleteCondition_: Function;
    ...
    constructor(options: ModifyOptions) {
         ...
         */
        this.defaultDeleteCondition_ = function (mapBrowserEvent: ol.MapBrowserEvent) {
