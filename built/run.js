...
define("google-polyline", ["require", "exports", "openlayers"], function (require, exports, ol) {
    "use strict";
    var reader = new ol.format.Polyline();
    var PolylineEncoder = (function () {
        function PolylineEncoder() {
        }
        PolylineEncoder.prototype.decode = function (str, precision) {
            if (precision === void 0) { precision = 5; }
            return reader.readGeometryFromText(str, {
                factor: Math.pow(10, precision)
            }).getCoordinates();
        };
        PolylineEncoder.prototype.encode = function (coordinates, precision) {
            if (precision === void 0) { precision = 5; }
            return (reader.writeGeometryText(new ol.geom.LineString(coordinates)));
        };
...
define("data/geom/parcel", ["require", "exports"], function (require, exports) {
    "use strict";
    return [
        [
...
define("data/geom/point", ["require", "exports"], function (require, exports) {
    "use strict";
    return [-115.2553, 36.1832];
});
define("data/geom/polygon-with-holes", ["require", "exports"], function (require, exports) {
    "use strict";
    return [
        [
...
define("labs/polyline-encoder", ["require", "exports", "jquery", "openlayers", "google-polyline"], function (require, exports, $, ol, PolylineEncoder) {
    "use strict";
    var PRECISION = 6;
...
define("labs/style-to-canvas", ["require", "exports", "openlayers", "jquery", "labs/common/snapshot", "data/geom/parcel"], function (require, exports, ol, $, Snapshot, parcel) {
    "use strict";
